...
async def main(message: cl.Message):
    ...
    """
    # Retrieve context using hf_retriever
    retriever = hf_retriever
    context_docs = retriever.get_relevant_documents(message.content)  # FIXED
    ...
    async for chunk in lcel_rag_chain.astream(
        {"query": message.content, "context": context},  # Pass both query and context
